...
const ContactForm = () => {
  ...
  const handleFormSubmit = async (values) => {
    ...
    var payload = {
      ...
      subject: "Contact Form Submission - Jantelliq",
      body: emailBody,
    };
  ...
  return (
    <div className="wrapper py-[5rem] grid lg:grid-cols-[45%_auto] gap-7">
      ...
      >
        ...
        <h2 className="heading-2 mt-5 text-black">Get in Touch</h2>
        <p className="desc">
        ...
        >
          <div className="w-[2.5rem] h-[2.5rem] rounded-full bg-primary flex justify-center items-center">
            <FaPhone className="text-2xl scale-x-[-1] text-white" />
          </div>
        ...
        >
          <div className="w-[2.5rem] h-[2.5rem] rounded-full bg-primary flex justify-center items-center">
            <IoMail className="text-3xl scale-x-[-1] text-white" />
          </div>
          <div className="flex flex-col h-full">
        ...
        <div className="flex items-start gap-3 w-fit mt-5">
          <div className="min-w-[2.5rem] w-[2.5rem] h-[2.5rem] rounded-full bg-primary flex justify-center items-center">
            <FaLocationDot className="text-2xl scale-x-[-1] text-white" />
          </div>
          <div className="flex flex-col h-full">
      ...
      >
        ...
        <div className="flex gap-5 items-center text-black mb-1">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link className="group w-[2.5rem] h-[2.5rem] rounded-full border-primary border flex justify-center items-center">
              <BsYoutube className="text-xl text-black group-hover:text-primary transition-all duration-300" />
            </Link>
          </div>
        </div>
      </div>
