...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-[5rem] text-black ">
      <div className="wrapper">
        <div className="h-full grid md:grid-cols-2 gap-10 py-10">
          ...
          >
            <div className="">
              <input
                className="w-full bg-transparent outline-none border rounded-sm font-light border-primary placeholder:text-black px-2 py-3"
                type="text"
